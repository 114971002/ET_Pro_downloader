...
class RuleTransformerTests(unittest.TestCase):
    ...
    def test_transform_home_net_to_twnic_nets(self):
        ...
        self.assertIn("gid:8; sid:1000001;", result)
    ...
    def test_multiple_home_net_replacements(self):
        ...
        self.assertIn("gid:8; sid:1000002;", result)

    def test_insert_gid_before_sid(self):
        line = 'alert udp any any -> any 53 (msg:"DNS query"; classtype:bad-traffic; sid:1000003; rev:2;)'
        result = transform_rule_line(line)
        self.assertIn("; gid:8; sid:1000003;", result)

    def test_custom_gid_parameter(self):
        line = 'alert udp any any -> any 53 (msg:"DNS query"; sid:1000003; rev:2;)'
        result = transform_rule_line(line, gid=8)
        self.assertIn("gid:8; sid:1000003;", result)

    def test_do_not_duplicate_gid_if_already_present(self):
        line = 'alert tcp any any -> any any (msg:"Has GID"; gid:1; sid:1000004; rev:1;)'
        result = transform_rule_line(line)
        self.assertNotIn("gid:8;", result)
    ...
    def test_full_file_transformation(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            stats = transform_rules_for_transfer(source_file, output_file, gid=8)
            ...
            self.assertIn("gid:8; sid:2000001;", output_lines[1])
            self.assertIn("gid:8; sid:2000002;", output_lines[2])
            self.assertIn("gid:8; sid:2000003;", output_lines[3])
